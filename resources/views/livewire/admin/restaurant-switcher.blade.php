...
{{-- ── Modo HEADER: solo el panel interior ─────────────────────────────── --}}
{{-- El trigger (<details><summary>) vive en app.blade.php fuera de Livewire --}}
<div class="w-72 rounded-2xl border border-gray-100 bg-white shadow-xl overflow-hidden">
