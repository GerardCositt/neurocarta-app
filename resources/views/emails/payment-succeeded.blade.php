...
<head>
    ...
    <style>
        ...
        .badge { display: inline-block; background: rgba(34,197,94,.15); color: #4ade80; font-size: 13px; font-weight: 700; padding: 5px 14px; border-radius: 20px; margin-bottom: 20px; }
...
<body>
    <div class="wrapper">
        ...
        <div class="card">
            ...
            <a href="{{ config('app.url') }}/dashboard" class="btn">Ir al panel</a>
