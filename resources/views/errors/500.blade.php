...
<head>
    ...
    <title>500 — La cocina está en llamas · NeuroCarta.ai</title>
...
<body>
    <div class="card">
        ...
        <h1>La cocina está en llamas</h1>
        <p>
            Algo ha salido mal en nuestros servidores.<br>
            El equipo ya está apagando el fuego — inténtalo de nuevo en unos minutos.
        </p>
