...
var flatpickrModule = __webpack_require__(/*! flatpickr */ "./node_modules/flatpickr/dist/esm/index.js");
var flatpickr = flatpickrModule["default"] || flatpickrModule;
var Spanish = (__webpack_require__(/*! flatpickr/dist/l10n/es.js */ "./node_modules/flatpickr/dist/l10n/es.js").Spanish);
    ...
    flatpickr(input, {
      ...
      onReady: function onReady(_, __, instance) {
        ...
        if (isDateTime && instance.hourElement && instance.minuteElement) {
          var onTimeWheel = function onTimeWheel(e) {
            if (e.ctrlKey) {
              return;
            }
            e.preventDefault();
          ...
          instance.hourElement.addEventListener('wheel', onTimeWheel, {
            passive: false
          });
          instance.minuteElement.addEventListener('wheel', onTimeWheel, {
            passive: false
          });
        }
      },
      onClose: function onClose(selectedDates, dateStr) {
        var storageValue = selectedDates && selectedDates[0] ? flatpickr.formatDate(selectedDates[0], isDateTime ? 'Y-m-d H:i' : 'Y-m-d') : '';
        if (modelInput) {
    ...
    window.Livewire.hook('message.processed', function (_, component) {
      ...
      getFlatpickrRoot().querySelectorAll('input[data-flatpickr]').forEach(function (input) {
        ...
        if ((modelInput.value || '') !== (input.value || '')) {
          var isDateTime = input.getAttribute('data-flatpickr-mode') === 'datetime';
          input._flatpickr.setDate(modelInput.value || '', false, isDateTime ? 'Y-m-d H:i' : 'Y-m-d');
          if (!modelInput.value) {
            input.value = '';
          }
        }
    ...
    var observer = new MutationObserver(function (mutations) {
      var shouldInit = mutations.some(function (mutation) {
        return Array.prototype.some.call(mutation.addedNodes || [], function (node) {
          return node.nodeType === 1 && (node.matches && node.matches('input[data-flatpickr]') || node.querySelector && node.querySelector('input[data-flatpickr]'));
        });
      });
      if (shouldInit) {
...
/***/ "./resources/css/carta-design-tokens.css"
/*!***********************************************!*\
  !*** ./resources/css/carta-design-tokens.css ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 	__webpack_require__.O(undefined, ["css/carta-design-tokens","css/app"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/carta-design-tokens","css/app"], () => (__webpack_require__("./resources/css/app.css")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/carta-design-tokens","css/app"], () => (__webpack_require__("./resources/css/carta-design-tokens.css")))
